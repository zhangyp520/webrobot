!(function (win, $) {
    ...
    var AbsoluteDesign = {
        ...
        'color,fontWeight,textAlign,whiteSpace').split(','),
        ...
        ***/
        ...
        initByUrlParams:function(callback){
            ...
            var designTplUrl = oui.getContextPath()+'res_engine/page_design/common/page-design-tpl.html';
        ...
        init4static: function () {
            var me = this;
            /** 页面属性配置   ****/
            me.pageKeys = 'id,name,version,canCloneControl,backgroundImageId,backgroundImageName,backgroundImage,description,pageDesignType,listContent,content,selectContent,style,innerStyle,controls,otherAttrs,events'.split(',');
            /** 页面类型枚举*****/
            me.paperRuleTypes = [
                {
                    width: 420,
            ...
            /**
             *
             * 控件的属性列表 id,name,title,description,htmlType,controlType,showType,fieldType,isFormField,style,innerStyle,otherAttrs,events
             * ****/
        ...
        isFormField: function (control) { //判断控件是否是页面字段
            var flag = true;
        ...
        showOperationSelectByTableLineSelectRect:function(tableLine,rect){
            ...
            if(rect){
                ...
                for(var columnIndex =rect.startColumnIndex;columnIndex<=rect.endColumnIndex;columnIndex++){
                    columnSelector.push('.control-column-num-abs[line-column-index='+columnIndex+']');
                }
                for(var rowIndex=rect.startRowIndex;rowIndex<=rect.endRowIndex;rowIndex++){
                    rowSelector.push('.control-row-num-abs[line-row-index='+rowIndex+']');
                }
        ...
        removeControlsByIds:function(ids){
            ...
            for(var i= 0,len=ids.length;i<len;i++){
                ...
                if(curr){
                    disableSelector.push('.control-abs-disable[control-abs-id='+curr.id+']');
                }
            ...
            if(disableSelector&&disableSelector.length){
                $(disableSelector.join(','),'.design-left').removeClass('control-abs-disable'); //取消禁用
            }
        },
        ...
        bindDragEvents:function(){
            ...
            this.bindDrag({
                ...
                cancelSelector: '.control-abs-disable,.design-copy-ctrl,.design-del-ctrl,.tableLine-edit-icon,.proxy-drag-placeholder,.proxy-dragging-select-area',//不允许拖拽元素
        ...
        updateCurrControlStyle:function(){
            ...
            if(currField&&currField.id){
                ...
                if(me.inDetail(currField)){
                    ...
                    if(currField.isFormField){ //只有表单控件才更新
        ...
        dragEndControl:function(cfg){
            ...
            if (isResizer) { //改变大小
                ...
                if (isUpdate) { //update
                    ...
                    $(container).find('.paper-area').append(html);
                    me.dragEndControlByPageDesignType(currField,cfg,isDrag2Table,mousePos4realtive); //根据页面类型进行后置渲染
                    $('.active','.paper-area').removeClass('active');
                    $('#' + currField.id).addClass('active');
        ...
        showOperationArea:function(currField,cfg){
            ...
            if(currField.htmlType =='tableLine'){
                ...
                if(!$('.control-line-abs[control-abs-id='+currField.id+']').length){
        ...
        changeAllControls:function(key,value){
            ...
            for(var i= 0,len=controls.length;i<len;i++){
                ...
                //if(isLayoutTypeProp && (!controls[i].isFormField)){
                //    continue;
                //}
                try{
        ...
        event2cloneControl: function (cfg) {
            ...
            var container = oui.getById('items').getEl();
            $(container).find('.paper-area').append(html+childHtmls.join(''));
            $('.active','.paper-area').removeClass('active');
        ...
        event2removeControl: function (cfg) {
            ...
            if(disableSelector.length){
                $(disableSelector.join(','),'.design-left').removeClass('control-abs-disable');
            }
        ...
        event2preview: function () {
            var me = this;
            var url =oui.getContextPath() + 'res_engine/page_design/pc/page-runtime.html';
        ...
        event2runForm:function(){
            ...
            var win = oui.openWindow({
                url: oui.getContextPath() + 'res_engine/page_design/pc/page-preview.html',
                //openType:'_blank',
                title: '预览'
            });
            win.bodyHtml = html;
