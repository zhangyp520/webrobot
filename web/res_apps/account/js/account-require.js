...
jsArray = jsArray.concat([
    oui.getContextPath()+'res_common/third/template/template_debug_3_0_0.js',
    oui.getContextPath()+ "res_common/oui/ui/base-control.js",
    oui.getContextPath()+"res_common/oui/system/oui-common.js",
    oui.getContextPath()+"res_common/oui/system/oui-datautils.js",
    oui.getContextPath()+"res_common/oui/system/oui-checkform.js"
]);
...
jsArray.push(oui.getContextPath()+"res_common/oui/system/oui-jsclazz.js");
jsArray.push(oui.getContextPath()+"res_common/oui/system/oui-biz-ext.js");
...
oui.require(jsArray,function(){
    oui.require([oui.getContextPath()+"res_apps/account/js/account.js"],function(){
        var me = com.oui.models.account.web.AccountController;
        me.init();
    });
},function(){},true);
