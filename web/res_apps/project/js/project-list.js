!(function (win, $) {
    ...
    var ProjectController4List = {
        "package": "com.oui.models.project.web",
        ...
        event2create:function(cfg){
            ...
            com.oui.models.portal.web.PortalController.doActionByMenuUrl("res_apps/project/project.tpl.html",params);
        },
        event2edit:function(cfg){
            var me = this;
            var projectId = $(cfg.el).attr('project-id');
            var loadUrl =$(cfg.el).attr('project-load-url');
            com.oui.models.portal.web.PortalController.doActionByMenuUrl("res_apps/project/project.tpl.html",{
        ...
        event2design:function(cfg){
            ...
            com.oui.models.portal.web.PortalController.doActionByMenuUrl("res_apps/project/project-design.tpl.html",{
                circleId:me.urlParams.circleId||'',
                id:projectId,
