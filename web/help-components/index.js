...
//向导描述
//元素定位
//向导显示在定位元素的位置：上、下、左、右； 默认下方
//根据当前页面路径 加载向导列表
//根据向导id加载向导选择器列表(包含元素定位规则列表)
!(function(){
    //ajax获取 帮助系统中当前业务系统和当前业务系统url对应的向导列表
    ...
    //根据系统id参数集成向导组件
    //获取当前脚本url 如 http://127.0.0.1:8080/help-components/res_common/index.js?sysId=${sysId}
    ...
    //在portal中 根据系统id查询系统信息，根据页面url和系统id查询向导列表，和选择器列表
    //显示 操作按钮 "show me how"

    //点击 操作按钮后 ajax 加载向导列表
    ...
    if(window['oui_context']){
        ...
        window.oui_context = {
            ...
            "routerViewInnerId":"router-view-help-comp-inner",
