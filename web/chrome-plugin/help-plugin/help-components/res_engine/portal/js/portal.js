!(function (win, $) {
    ...
    var PortalController = {
        ...
        init:function(){
            ...
            if(me.data.helpState =="runtime" || me.data.helpState =='runtime4preview'){ //非运行态不执行 帮助向导
                me.loadAll(); //加载所有资源
            }
        },
        ...
        event2showLayoutPanel:function(cfg){
            //help-plugin-runtime-show
            var me = this;

            var $helpPlugin = $(cfg.el).parent();
            if($helpPlugin.hasClass('help-plugin-runtime-show')){
                me.hidePlugin();
            }else{
                me.showPlugin();
            }
        ...
        event2toggle:function(cfg){
            var me = this;
            var $sysPanel = $('#help-plugin-runtime .help-sys-runtime');
            var $eidt = $('#help-plugin-runtime .help-page-runtime');
            if($sysPanel.hasClass('current')){
                ...
                var $iframe = $('#help-plugin-runtime-iframe');
                if(!$iframe[0].src){
        ...
        //显示插件
        showPlugin:function(){
            $('#help-plugin-runtime').addClass('help-plugin-runtime-show');
            var me = this;
        ...
        changeIframeHeight:function(){
            ...
            if($iframe && $iframe.length){
                ...
                var height = $('#help-plugin-runtime .help-plugin-runtime-view.current').height();
                $iframe[0].height=height-2;
            }
        },
        //隐藏插件
        hidePlugin:function(){
            $('#help-plugin-runtime').removeClass('help-plugin-runtime-show');
        },
        _data:function(){
          return this;
        },
                ...
                if(typeof data =='object'){
                    ...
                    if(data.callbackId){
                        ...
                        if(data.cmd&&data.param){
                            ...
                            console.log('help-runtime:'+data.cmd);
                            console.log(data);
        ...
        renderByLoadSys:function(hasChange){
            oui.getById('help-page-runtime-content').render(); //编辑页面渲染
            oui.getById('help-sys-runtime-header-info').render(); //系统信息头部渲染
            if(hasChange){
                oui.router.push('tpl/welcome.vue.html');
            }
        },
