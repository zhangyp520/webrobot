...
(function (factory) {
  ...
  */
  ...
  var Editor = function (context) {
    ...
    context.memo('webrobot.undo', lang.webrobot.undo);
    ...
    context.memo('webrobot.redo', lang.webrobot.redo);
    ...
    for (var idx = 0, len = commands.length; idx < len; idx ++) {
      ...
      context.memo('webrobot.' + commands[idx], lang.webrobot[commands[idx]]);
    }
    /* jshint ignore:end */
    ...
    context.memo('webrobot.tab', lang.webrobot.tab);
    ...
    context.memo('webrobot.untab', lang.webrobot.untab);
    ...
    context.memo('webrobot.insertParagraph', lang.webrobot.insertParagraph);

    this.insertOrderedList = this.wrapCommand(function () {
      bullet.insertOrderedList(editable);
    });
    context.memo('webrobot.insertOrderedList', lang.webrobot.insertOrderedList);

    this.insertUnorderedList = this.wrapCommand(function () {
      bullet.insertUnorderedList(editable);
    });
    context.memo('webrobot.insertUnorderedList', lang.webrobot.insertUnorderedList);

    this.indent = this.wrapCommand(function () {
      bullet.indent(editable);
    });
    context.memo('webrobot.indent', lang.webrobot.indent);

    this.outdent = this.wrapCommand(function () {
      bullet.outdent(editable);
    });
    context.memo('webrobot.outdent', lang.webrobot.outdent);
    ...
    context.memo('webrobot.formatPara', lang.webrobot.formatPara);
    ...
    for (var idx = 1; idx <= 6; idx ++) {
      ...
      context.memo('webrobot.formatH'+idx, lang.webrobot['formatH' + idx]);
    };
    /* jshint ignore:end */
    ...
    context.memo('webrobot.insertHorizontalRule', lang.webrobot.insertHorizontalRule);
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.webrobot', function () {
        return ui.button({
          contents: ui.icon(options.icons.question),
          tooltip: lang.options.webrobot,
          click: context.createInvokeHandler('webrobotDialog.show')
        }).render();
      });
    };
  ...
  var LinkDialog = function (context) {
    ...
    context.memo('webrobot.linkDialog.show', options.langInfo.webrobot['linkDialog.show']);
  };
  ...
  var HelpDialog = function (context) {
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = $('<div><div class="webrobot-list-item"/></div>');
        $row.append($('<label><kbd>' + key + '</kdb></label>').css({
          'width': 180,
          'margin-right': 10
        })).append($('<span/>').html(context.memo('webrobot.' + command) || command));
        return $row.html();
      }).join('');
    };
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['view', ['fullscreen', 'codeview', 'webrobot']]
      ],
