(function(win){
  ...
  /*
     ...
     *	最大长度
     ...
     email:邮箱地址
     */
  var validatorNames ="require,minLength,maxLength,minValue,maxValue,checkedSizeGt,checkedSizeLt,checkedSizeEq,phone,email,number,dotNum,specialChars,website,tel,fax,qq,fileUploadLimit,imageUploadLimit,lettersOrNumber,dateYMD,dateYM,dateY,dateYMDhms,dateYMDhm,dateYMDh,enumData".split(',');
  /**
   * 校验类
   */
  var Validator = {
